...
const DetailDokter = () => {
  ...
  return (
    <main className="min-h-screen bg-slate-50/50 pb-16">
      {/* Hero Section */}
      <section
        className="relative flex min-h-[30vh] w-full items-end overflow-hidden bg-cover bg-center lg:min-h-[40vh]"
        style={{
          backgroundImage: `url(${detailDokter.foto})`,
        }}
      >
        <div className="absolute inset-0 bg-linear-to-t from-slate-950/90 via-slate-950/50 to-transparent backdrop-blur-xs" />
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-7xl items-center gap-4 p-6 text-white lg:px-10 lg:pb-10">
          ...
          <div className="space-y-1">
            ...
            <h1 className="font-DMSerif text-2xl tracking-tight lg:text-4xl">
              {detailDokter.nama}
            </h1>
          </div>
        </div>
